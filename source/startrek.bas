...
2030 PRINT "***THE "; S5$; " HAS S TO PPED IN A QUADRANT ";
2040 PRINT "CONTAINING A SUPERNOVA."
2050 PRINT "*** EMERGENCY AU TO -OVERRIDE ATTEMPTS  TO  HURL ";
2060 PRINT S5$
...
9390 F1(5) = 1E+30: GOTO 9001
9400 F1(4) = 1E+30: F1(5) = 1E+30: GOTO 9001
...
9475 F1(5) = 1E+30: IF (R2 = 0) OR (R3 = 0) THEN 9001
...
10272 PRINT "OF SUB-A TO MIC PARTICLES...": GOTO 10300
...
10355 PRINT "SINCE YOU  TO OK THE LAST KLINGON WITH YOU, YOU ARE"
...
13130 PRINT FNR(.004 * (E1 - 50) - .05); "QUADRANTS.'": RETURN
13140 T1 = D1 / .4
...
15133 PRINT "EMERGENCY S TO P REQUIRED"; FNR(K); "UNITS OF ENERGY."
15135 E1 = E1 - K
...
21130 A3 = C6 + .25 * R: IF N = 1 THEN 21140
...
21400 GOTO 21435
21405
PRINT : PRINT "AAAAAIIIIIIIEEEEEEEAAAAAAAUUUUUUGGGGGGGHHHHHHHHHH!!!"
...
24240 FOR I = 1 TO I4
24250 X = FNA(1): Y = FNA(1): IF (G(X, Y) < 99) AND (RND(1) < .75) THEN 24250
...
27140 PRINT "*** EMERGENCY AU TO -OVERRIDE JAMMED ***": A2 = 1: GOTO 27180
...
27250 R2 = R2 - 1: R = R - 1: Q = 1: IF R2 = 0 THEN F1(2) = 1E+30
27260 NEXT L
...
28100 RETURN
29000 REM-SRSCAN
29001 IF D4(1) <> 0 THEN 29230 'D(1) like in the original was never initiated D4=Dameges ??? Thomas
...
31075 J3 = 1
31080 T1 = .1: P5 = (K3 + 4 * C3) / 48: IF P5 < .1 THEN P5 = .1
...
32020 T1 = .05: P = (K3 + 4 * C3) / 48: IF P < .05 THEN P = .05
...
34030 P = (D1 + .05) * W1 * W1 * W1 * (S4 + 1): IF P < E1 THEN 34150
...
34080 W = INT((E1 / (D1 + .05)) ^ .333333): IF W <= 0 THEN 34130
...
34140 RETURN
34150 T1 = 10 * D1 / W2: IF T1 < .8 * R5 THEN 34500
...
34600 FOR L = 1 TO N
34610 X = X + X1: Q = INT(X + .5): IF (Q < 1) OR (Q > 10) THEN 34660
34620 Y = Y + Y1: R = INT(Y + .5): IF (R < 1) OR (R > 10) THEN 34660
...
37000 REM - STATUS
37001 FOR I = 1 TO 10: NEXT I: GOTO 29040: RETURN
37010 END
